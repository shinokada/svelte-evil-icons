...
<MetaTags
  title="{title}"
  description="Evil icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-evil-icons.vercel.app/',
    title: "Svelte Evil Icons",
    description: "Evil icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-evil-icons', width: 1200, height: 630, alt: "Svelte Evil Icons" }],
    site_name: 'Svelte Evil Icons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte Evil Icons",
    description: "Evil icon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-evil-icons',
...
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-900">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-900 ">
    ...
    <NavLi href="https://github.com/shinokada/svelte-evil-icons">GitHub</NavLi>
...
/>
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    ...
    <FooterLink href="https://github.com/shinokada/svelte-evil-icons/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-evil-icons/">GitHub</FooterLink>
  </FooterLinkGroup>
  </div>
</Footer>
