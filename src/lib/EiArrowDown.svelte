<script>
  ...
  export let ariaLabel = 'ei arrow down';
</script>
...
<svg
  ...
  /><path d="M25 34.4l-9.7-9.7 1.4-1.4 8.3 8.3 8.3-8.3 1.4 1.4z" /><path d="M24 16h2v17h-2z" /></svg
>
...
@prop export let ariaLabel = 'ei arrow down';
-->
