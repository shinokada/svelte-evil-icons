<script>
  ...
  export let ariaLabel = 'ei chevron right';
</script>
...
<svg
  ...
  on:mouseover
  on:mouseout
  viewBox="0 0 50 50"><path d="M22.7 34.7l-1.4-1.4 8.3-8.3-8.3-8.3 1.4-1.4 9.7 9.7z" /></svg
>
...
@prop export let ariaLabel = 'ei chevron right';
-->
