<script>
  ...
  export let ariaLabel = 'ei sc facebook';
</script>
...
<svg
  ...
  on:mouseout
  viewBox="0 0 50 50"
  ><path d="M26 20v-3c0-1.3.3-2 2.4-2H31v-5h-4c-5 0-7 3.3-7 7v3h-4v5h4v15h6V25h4.4l.6-5h-5z" /></svg
>
...
@prop export let ariaLabel = 'ei sc facebook';
-->
