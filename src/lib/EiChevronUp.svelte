<script>
  ...
  export let ariaLabel = 'ei chevron up';
</script>
...
<svg
  ...
  on:mouseover
  on:mouseout
  viewBox="0 0 50 50"><path d="M33.3 28.7L25 20.4l-8.3 8.3-1.4-1.4 9.7-9.7 9.7 9.7z" /></svg
>
...
@prop export let ariaLabel = 'ei chevron up';
-->
